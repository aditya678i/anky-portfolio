...
export default function FaqMonochrome(props: FaqMonochromeProps) {
    ...
    const questionStyle = {
        fontSize: questionFont?.fontSize || "clamp(16px, 2.5vw, 24px)",
        fontWeight: questionFont?.fontWeight || 500,
        fontFamily:
            questionFont?.fontFamily || "Inter, -apple-system, sans-serif",
    ...
    const answerStyle = {
        ...
        fontFamily:
            answerFont?.fontFamily || "Inter, -apple-system, sans-serif",
    ...
    return (
        <section
            style={{
                background: bg,
                width: "100%",
                padding: `clamp(40px, 8vw, ${padding}px) clamp(16px, 4vw, 40px)`,
                display: "flex",
